...
createText(){const element=document.createElement("canvas");const canvas=new fabric.Canvas(element);const text=new fabric.Text(this.labelText,{left:0,top:0,fill:this.textColor,fontFamily:"Mulish",fontSize:"76"});canvas.add(text);return element}}
